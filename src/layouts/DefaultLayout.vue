...
<template>
  <div class="relative min-h-screen flex flex-col bg-gray-50 overflow-x-hidden"
    ...
    <!-- Footer fijo -->
<div class="fixed bottom-0 left-0 right-0 z-50 flex gap-2 border-t border-[#eaedf1] bg-gray-50 px-4 pt-2" style="padding-bottom: calc(12px + env(safe-area-inset-bottom, 0px));">
