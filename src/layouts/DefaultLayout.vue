...
<template>
  <div class="relative min-h-screen flex flex-col bg-gray-50 overflow-x-hidden"
    ...
    <main class="relative flex-1 overflow-y-auto pb-28" style="padding-top: max(12px, env(safe-area-inset-top, 0px));">
      <!-- Loader -->
      <div v-if="loading" class="absolute inset-x-0 top-0 bottom-28 z-30 flex items-center justify-center bg-gray-50">
