          ...
          <div v-for="complejo in complejosFiltrados" :key="complejo.id" class="animate-slide-up">
            <div
              ...
              <div class="relative aspect-[16/10] overflow-hidden">
                ...
                <div class="absolute bottom-5 left-2 right-2 flex items-end justify-between">
                  <div class="space-y-1">
              ...
              <!-- Footer Details -->
              <div class="px-2 py-5 flex items-center justify-between bg-white border-t border-slate-50">
